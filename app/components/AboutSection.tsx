    ...
    const socialButtons = [
      {
        ...
        href: 'https://github.com/amanbangeraa',
      ...
      },
      {
        ...
        href: 'https://twitter.com/amanbangeraa',
      ...
      },
      {
        ...
        href: 'https://linkedin.com/in/amanbangeraa',
              ...
              `}>
                {socialButtons.map((social, index) => (
                  <a
                    ...
                    `}
                    style={{
                      transitionDelay: isActive ? `${200 + index * 100}ms` : '0ms'
                    }}
                    onClick={(e) => {
                      // Prevent button click when clicking social links
                      e.stopPropagation();
                    }}
                  >
